...
class MainWindow(wx.Frame):
    ...
    def init_layout(self):
        ...
        self.field1 = ExpandoTextCtrl(mainpanel, style=wx.TE_MULTILINE | wx.TE_READONLY | wx.TE_DONTWRAP)
    ...
    def add_filenames(self, filenames):
        self.field1.AppendText("\n".join(filenames))
        self.field2.AppendText("\n".join(filenames))
